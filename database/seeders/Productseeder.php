    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            ...
            [
                'name'=>'puma sneakers',
                "price"=>"1000",
                "description"=>"puma turbanator",
                "categor"=>"branded",
                "gallery"=>"https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/359169/02/sv01/fnd/IND/fmt/png/Puma-1948-Mid-L"
            ]
        ]);
    }
}
